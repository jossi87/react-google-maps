...
var markerControlledPropTypes = {
  ...
  labelContent: _react.PropTypes.any,
  labelAnchor: _react.PropTypes.any,
  labelClass: _react.PropTypes.any,
  labelStyle: _react.PropTypes.any,
...
var MarkerCreator = (function (_Component) {
  ...
  _createClass(MarkerCreator, [{
    ...
    value: function _createMarker(markerProps) {
      ...
      // https://developers.google.com/maps/documentation/javascript/3.exp/reference#Marker
      var marker = new MarkerWithLabel((0, _utilsComposeOptions2["default"])(markerProps, markerControlledPropTypes));
